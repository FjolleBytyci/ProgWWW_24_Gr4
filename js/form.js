function Validimi() {
    ...
    if(x == ""|| x.match(/[0-9]/)|| x.match(/[A-Za-z]+[0-9]+[!@#$%^&*()_+":><?]/)){
      Mesazhi.innerHTML = "Keni shenuar emrin gabim";
    }
    else{
      Mesazhi.innerHTML = "";
    }
    ...
    if(y == ""|| y.match(/[0-9]/)|| y.match(/[A-Za-z]+[0-9]/)){
      Mesazhi1.innerHTML = "Keni shenuar emrin gabim";
    }
    else{
      Mesazhi1.innerHTML = "";
    }
    ...
    if(a == ""|| a.match(/[A-Za-z]/)|| a.match(/[A-Za-z]+[0-9]/)){
      Mesazhi2.innerHTML = "Keni shenuar numrin gabim";
    }
  ...
  //==========================================================================================
    ...
    if(b == ""|| b.match(/[A-Za-z]/)|| b.match(/[A-Za-z]+[0-9]/)){
      Mesazhi3.innerHTML = "Keni shenuar numrin gabim";
    }
    ...
    if(d == ""|| d.match(/[0-9]/)|| d.match(/[A-Za-z]+[0-9]+[!@#$%^&*()_+":><?]/)){
      Mesazhi5.innerHTML = "Keni shenuar emrin gabim";
    }
    else{
      Mesazhi5.innerHTML = "";
    }
    ...
    if(e == ""|| e.match(/[0-9]/)|| e.match(/[A-Za-z]+[0-9]+[!@#$%^&*()_+":><?]/)){
      Mesazhi6.innerHTML = "Keni shenuar emrin gabim";
    }
    else{
      Mesazhi6.innerHTML = "";
    }
    ...
    if(f == ""|| f.match(/[A-Za-z]/)|| f.match(/[A-Za-z]+[0-9]/)){
      Mesazhi7.innerHTML = "Keni shenuar numrin gabim";
    }
    ...
    if(g == ""|| g.match(/[A-Za-z]/)|| g.match(/[A-Za-z]+[0-9]/)){
      Mesazhi8.innerHTML = "Keni shenuar numrin gabim";
    }
    else if(b.length>15){
    ...
    if(h == ""|| h.match(/[A-Za-z]/)|| h.match(/[A-Za-z]+[0-9]/)){
      Mesazhi9.innerHTML = "Keni shenuar numrin gabim";
    }
